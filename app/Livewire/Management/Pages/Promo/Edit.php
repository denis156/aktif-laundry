...
namespace App\Livewire\Management\Pages\Promo;
...
class Edit extends Component
{
    ...
    protected function loadPromo(): void
    {
        try {
            ...
            $this->formData = [
                ...
                'tanggal_mulai' => $promo->tanggal_mulai->format('Y-m-d\TH:i'),
                'tanggal_berakhir' => $promo->tanggal_berakhir->format('Y-m-d\TH:i'),
    ...
    {
        return view('livewire.management.pages.promo.edit', [
