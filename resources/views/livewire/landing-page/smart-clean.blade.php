<section id="smart-clean" class="min-h-dvh bg-base-100 w-full scroll-mt-auto py-20">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-16 max-w-4xl mx-auto">
            ...
            <div class="space-y-6 text-base-content/80 text-md leading-relaxed">
                <p class="max-w-2xl mx-auto">
                    ...
                    hadir buat kamu yang ngga mau ribet tetapi tetap mau tampil maksimal.<br class="hidden sm:inline" />
                    Kami ngerti hidup kamu yang cepat, dinamis, dan
                    penuh gaya.
                </p>
            </div>
        </div>
        ...
        <!-- Manfaat Utama -->
        <div
            class="flex md:grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto mt-16 overflow-x-auto md:overflow-visible no-scrollbar p-4">

            <div
                class="flex-none w-[74dvw] md:w-auto card bg-base-200 shadow-md hover:shadow-xl transition-shadow duration-300">
                <figure>
                ...
                <div class="card-body border-t-2 border-base-content border-dashed">
                    ...
                    <p class="text-base-content/70">
                        Selalu tampil rapi & wangi agar menjaga performamu lebih produktif
                    </p>
            ...
            <div
                ...
                <div class="card-body border-t-2 border-base-content border-dashed">
                    <h2 class="card-title text-success">Aktif Nongkrong</h2>
                    <p class="text-base-content/70">
                        Semakin gaya & pede saat nongkrong bersama teman karena outfit-mu selalu lebih rapi dan stylish
                    </p>
                    <div class="card-actions justify-end">
            ...
            <div
                ...
                <div class="card-body border-t-2 border-base-content border-dashed">
                    ...
                    <p class="text-base-content/70">
                        Jalani hidup smart dengan laundry hemat, waktu & energimu semakin aktif belajar & berekspresi
                    </p>
                    <div class="card-actions justify-end">
        ...
        <div class="text-center mt-20">
            <x-button no-wire-navigate link="#pesan" label="Kami Bukan Hanya Sekedar Mencuci"
