<div class="container mx-auto">
    <x-header title="Riwayat Transaksi" subtitle="Lihat semua riwayat transaksi laundry Anda" icon="iconpark.history-o"
    ...
    <div class="space-y-4 mb-24">
        ...
        <x-card class="shadow-lg border border-primary"
            ...
            <div class="w-20 h-20 rounded-full bg-base-200 flex items-center justify-center">
                <x-icon name="iconpark.history-o" class="h-10 text-base-content/40" />
            </div>
            <div class="text-center space-y-2">
                <h3 class="text-lg font-bold text-base-content">Belum Ada Riwayat</h3>
