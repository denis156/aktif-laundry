<nav class="dock bg-base-200 text-base-content border-t-4 border-primary rounded-t-2xl bottom-0 z-50">
    @foreach ($navigationItems as $item)
        ...
        <a class="{{ $buttonClasses }}" href="{{ route($item['route']) }}" wire:navigate>
