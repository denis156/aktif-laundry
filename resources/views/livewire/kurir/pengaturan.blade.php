    ...
    <div class="space-y-4 flex flex-col justify-center items-center mb-24">
        ...
        <div class="w-full space-y-2">
            ...
            <x-card class="shadow-lg border border-primary">
                <div class="flex justify-between items-center">
                    ...
                    <x-theme-toggle class="btn btn-neutral btn-circle" />
                </div>
                <div class="divider"></div>
                <p class="text-sm text-base-content/60">Aktifkan mode gelap untuk mengurangi ketegangan mata dan menghemat baterai perangkat</p>
            </x-card>
        </div>
        ...
        <div class="w-full space-y-2">
            ...
            <x-card class="shadow-lg border border-primary">
                ...
                <div class="divider"></div>
                <p class="text-sm text-base-content/60">Terima notifikasi instan saat ada pesanan laundry yang perlu dijemput atau diantar</p>
            </x-card>
        </div>
        ...
        <div class="w-full space-y-2">
            ...
            <x-card class="shadow-lg border border-primary">
                ...
                <div class="divider"></div>
                <p class="text-sm text-base-content/60">Perbarui nama, telepon, dan email untuk komunikasi lancar dengan pelanggan</p>
            </x-card>
        </div>
        ...
        <div class="w-full space-y-2">
            ...
            <x-card class="shadow-lg border border-primary">
                ...
                <div class="divider"></div>
                <p class="text-sm text-base-content/60">Kelola keamanan akun termasuk ubah sandi dan keluar dari sistem</p>
            </x-card>
        </div>
