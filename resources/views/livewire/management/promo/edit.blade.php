<div>
    <x-header title="Edit Promo" separator progress-indicator>
        <x-slot:subtitle>
            Ubah data promo {{ $formData['kode_promo'] }}
        </x-slot:subtitle>
    </x-header>
        ...
        <div class="lg:grid grid-cols-5">
            ...
            <x-card class="col-span-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-input label="Kode Promo" wire:model="formData.kode_promo" placeholder="Contoh: NEWUSER10"
                        hint="Kode unik untuk promo ini" icon="o-hashtag" required />
