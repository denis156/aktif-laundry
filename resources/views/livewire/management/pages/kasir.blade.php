        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <!-- LOKASI SECTION -->
                        <div class="space-y-4">
                            ...
                            <livewire:management.components.map-picker :latitude="$pelangganBaru['latitude']"
            ...
            <x-card class="shadow-md">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Multi Layanan Form -->
                    <livewire:management.components.multi-layanan-form :key="'multi-layanan-'.$this->getId()" />
