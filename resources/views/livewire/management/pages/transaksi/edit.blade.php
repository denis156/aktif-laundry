<div>
    <x-header title="Edit Transaksi" separator progress-indicator>
        ...
        <x-slot:actions>
            <livewire:management.components.whats-app-button :transaksi-id="$transaksiId" size="md"
    ...
    <x-form wire:submit="save" no-separator>
        ...
        <div class="lg:grid grid-cols-5 mt-8">
            ...
            <x-card class="col-span-3">
                <livewire:management.components.multi-layanan-form :items="$multiLayananData['items']" />
            </x-card>
        </div>
