<div>
    <x-header title="Pengaturan Konfigurasi" icon="o-adjustments-horizontal"
        icon-classes="bg-primary text-primary-content rounded-full p-1 w-8 h-8" subtitle="Konfigurasi Sistem & Toko"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <x-card class="shadow-md">
                        ...
                        <x-input label="Nama Toko" wire:model="nama_toko" placeholder="Contoh: Aktif Laundry"
                            icon="o-building-storefront" required hint="Nama toko akan ditampilkan di struk" />
                    </x-card>
                    ...
                    <x-card class="shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-input label="WhatsApp" wire:model="whatsapp" prefix="+62" placeholder="81234567890"
                                required hint="Format: 8xxx (tanpa 0 atau +62)" />

                            <x-input label="Email" type="email" wire:model="email" placeholder="info@aktiflaundry.com"
                    ...
                    <x-card class="shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-datetime label="Jam Buka" type="time" wire:model="jam_buka" icon="o-sun" required />

                            <x-datetime label="Jam Tutup" type="time" wire:model="jam_tutup" icon="o-moon" required />
                        </div>
                    </x-card>
                    ...
                    <x-card class="shadow-md">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-input label="Format ID Jenis Pakaian" wire:model="format_id_jenis_pakaian"
                                placeholder="JNS" icon="o-tag" required hint="Contoh: JNS, JP-, JENIS-" />

                            <x-input label="Format ID Layanan" wire:model="format_id_layanan" placeholder="LYN"
                                icon="o-sparkles" required hint="Contoh: LYN, LY-, LAYANAN-" />

                            <x-input label="Format ID Pelanggan" wire:model="format_id_pelanggan" placeholder="PLG"
                                icon="o-user" required hint="Contoh: PLG, PL-, PELANGGAN-" />

                            <x-input label="Format ID Transaksi" wire:model="format_id_transaksi" placeholder="TRX"
                                icon="o-clipboard-document-list" required hint="Contoh: TRX, TR-, TRANSAKSI-" />

                            <x-input label="Format ID Kurir" wire:model="format_id_kurir" placeholder="KUR"
                                icon="o-truck" required hint="Contoh: KUR, KR-, KURIR-" />
                            ...
                            <x-input label="Format ID Referral" wire:model="format_id_referral" placeholder="REF"
                                icon="o-users" required hint="Contoh: REF, RF-, REFER-" />
                        </div>
                    </x-card>
                    ...
                    <x-card class="shadow-md">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start justify-between p-4 bg-base-200/50 rounded-lg">
                                ...
                                <x-toggle wire:model.live="enable_referral" class="ml-4" />
                            </div>
                            ...
                            <div class="flex items-start justify-between p-4 bg-base-200/50 rounded-lg">
                                ...
                                <x-toggle wire:model.live="enable_promo" class="ml-4" />
                            </div>
                        </div>
                    </x-card>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-4 space-y-6">
                            ...
                            <div class="text-center space-y-3">
                                ...
                                <div class="text-left space-y-2 bg-white/10 rounded-lg p-4">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-bold font-mono text-xs">{{ $format_id_jenis_pakaian ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-bold font-mono text-xs">{{ $format_id_pelanggan ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="opacity-80">Transaksi:</span>
                                        <span class="font-bold font-mono text-xs">{{ $format_id_transaksi ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-bold font-mono text-xs">{{ $format_id_pengiriman ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="opacity-80">Pembayaran:</span>
                                        <span class="font-bold font-mono text-xs">{{ $format_id_pembayaran ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-bold font-mono text-xs">{{ $format_id_referral ?: '-'
                                            }}</span>
                                    </div>
                                    <div class="divider divider-neutral opacity-20 my-2"></div>
                                    <div class="flex justify-between text-sm">
                        ...
                        <!-- Action Button -->
                        <x-button label="Simpan Pengaturan" type="submit" spinner="save"
                            class="btn-primary btn-lg w-full shadow-lg" icon="o-check" />
                    </div>
                </div>
            </div>
        </x-form>
