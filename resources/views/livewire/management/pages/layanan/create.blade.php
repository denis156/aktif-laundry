        ...
        <div class="lg:grid grid-cols-5">
            ...
            <x-card class="col-span-3">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-input label="Kode Layanan" wire:model="formData.kode_layanan" placeholder="Auto Generate"
            ...
            <x-card class="col-span-3">
                ...
                <div class="space-y-4 my-2">
                    <div class="form-control">
                        ...
                        <livewire:management.components.string-list-input :initialValue="$formData['include']"
                    ...
                    <div class="form-control">
                        ...
                        <livewire:management.components.string-list-input :initialValue="$formData['exclude']"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <livewire:management.components.icon-picker :initialValue="$formData['icon']"
