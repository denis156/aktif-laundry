            ...
            <div class="card-body p-4">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    @if(count($items) > 1)
                        <button
                            type="button"
                            wire:click="removeLayanan({{ $index }})"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @if(!empty($item['layanan_id']))
                            ...
                            @if($layanan && $layanan->tipe_layanan == 'per_kg')
                                <input
                                    type="text"
                                    wire:model.live="items.{{ $index }}.berat_kg"
                            ...
                            @elseif($layanan && $layanan->tipe_layanan == 'per_satuan')
                                <input
                                    type="number"
                                    wire:model.live="items.{{ $index }}.jumlah_satuan"
                    ...
                    @if($layanan && $layanan->tipe_layanan == 'per_kg')
                        ...
                        <div class="space-y-3 mt-3">
                            ...
                            <div class="border border-base-300 rounded-lg p-3 bg-base-50">
                                ...
                                <button
                                    type="button"
                                    wire:click="addJenisPakaian({{ $index }})"
