<div>
    ...
    <x-form wire:submit="save" no-separator>
        ...
        <div class="lg:grid grid-cols-5">
            ...
            <x-card class="col-span-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-input label="Kode Pelanggan" wire:model="formData.kode_pelanggan" readonly
        ...
        <div class="lg:grid grid-cols-5 mt-8">
            <div class="col-span-2">
                <x-header title="Status & Informasi Tambahan" subtitle="Status dan informasi pelanggan"
                    size="text-lg" />
            </div>
            <x-card class="col-span-3">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-datetime label="Tanggal Daftar" type="datetime-local" wire:model="formData.tanggal_daftar"
                    ...
                    <x-input label="Total Transaksi" wire:model="formData.total_transaksi" type="number" placeholder="0"
                        icon="o-shopping-bag" hint="Auto-increment saat transaksi" disabled />

                    <x-input label="Kode Referral Dipakai" wire:model="formData.kode_referral_dipakai"
                        placeholder="Kode referral (jika ada)" icon="o-ticket" hint="Opsional" disabled />

                    <x-input label="Direferensikan Oleh" wire:model="formData.direferensikan_oleh"
                        placeholder="ID Pelanggan referrer" icon="o-user-group" hint="Auto-set dari kode referral"
                        disabled />
                </div>
            </x-card>
        </div>
