<div wire:poll.visible.30s>
    <!-- HEADER -->
    <x-header title="Transaksi" icon="o-clipboard-document-list" icon-classes="bg-primary rounded-full p-1 w-8 h-8" subtitle="Riwayat & Manajemen Pesanan" separator progress-indicator>
